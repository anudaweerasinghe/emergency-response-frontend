                    ...
                    children: <Widget>[
                      Expanded(
                        ...
                        child: RaisedButton(
                          ...
                          textColor: newMessages ? Colors.white : Color(
                              0xFFFF4B2B),
                      ...
                      Expanded(
                        ...
                        child: RaisedButton(
                          ...
                          textColor: responded ? Colors.white : Color(
                              0xFFFF4B2B),
                          padding: const EdgeInsets.all(0.0),
                          color: Colors.transparent,
                          disabledElevation: 0,
                                    ...
                                    child: Column(
                                      children: <Widget>[
                                        ...
                                        Padding(padding: EdgeInsets.symmetric(
                                            vertical: 8, horizontal: 8),),
                                        Text(
                                            newMessages ? newMessagesList[index]
                                                .message : respondedList[index]
                                                .message,
                                            style: new TextStyle(
                                                fontSize: 13.0,
                                                  ...
                                                  if(userLocation==null){
                                                    ...
                                                    int response = await updateStatus(
                                                        newMessages
                                                            ...
                                                            .id
                                                            : respondedList[index]
                                                            .id, 1, phone, userLocation["latitude"],userLocation["longitude"]);
                                                    if (response != 200) {
                                                      _showDialog(
                                                  ...
                                                  if(userLocation==null){
                                                    ...
                                                    int response = await updateStatus(
                                                        newMessages
                                                            ...
                                                            .id
                                                            : respondedList[index]
                                                            .id, 2, phone, userLocation["latitude"],userLocation["longitude"]);
                                                    if (response != 200) {
                                                      _showDialog(
                                                          "We encountered an error while updating your status",
                                                          "Sorry!");
